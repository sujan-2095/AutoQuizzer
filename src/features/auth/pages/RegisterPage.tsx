...
import { AutoQuizzerLogo, PersonIcon, LockIcon } from '@/components/ui/Icons';
        ...
        <div className="max-w-md w-full space-y-8 bg-surface dark:bg-surface p-10 rounded-2xl shadow-2xl border border-border dark:border-border animate-slide-up">
            ...
            <div className="space-y-4">
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  <PersonIcon className="h-5 w-5 text-text-light-muted dark:text-text-muted" aria-hidden="true" />
                </div>
                <input
                  id="email-address"
                  name="email"
                  ...
                  autoComplete="email"
                  required
                  className="block w-full rounded-md border-0 bg-background dark:bg-background py-3 pl-10 pr-3 text-text dark:text-text-DEFAULT ring-1 ring-inset ring-border dark:ring-border placeholder:text-text-light-muted dark:placeholder:text-text-muted focus:ring-2 focus:ring-inset focus:ring-primary-light dark:focus:ring-primary sm:text-sm transition-all duration-300"
              ...
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  <LockIcon className="h-5 w-5 text-text-light-muted dark:text-text-muted" aria-hidden="true" />
                </div>
                <input
                  id="password"
                  name="password"
          ...
          <p className="mt-10 text-center text-sm text-text-light-muted dark:text-text-muted">
            ...
            <button
              ...
              className="font-semibold leading-6 text-primary-light dark:text-primary hover:text-primary-light-hover dark:hover:text-primary-hover hover:underline transition-colors duration-300"
            >
              Log in
            </button>
          </p>
